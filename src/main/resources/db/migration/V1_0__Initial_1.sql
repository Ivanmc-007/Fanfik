...
alter table if exists composition_genre 
...
alter table if exists composition_mark 
...
alter table if exists composition_tag 
...
alter table if exists mark_user 
...
alter table if exists paragraph_user 
